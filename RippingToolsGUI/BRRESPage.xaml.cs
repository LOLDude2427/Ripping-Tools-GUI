...
{
    /// <summary>
    /// Interaction logic for BRRESPage.xaml
    /// </summary>
    public partial class BRRESPage : Page
    {
        ...
        // These strings aren't relevant anymore, and are only kept right now to prevent breaking
        string SklDir = "None";
        string SklName = "None";
        ...
        private void btnBat_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (ModelName == "None")
            {
                MessageBox.Show("No *.brres selected.", "Not all parameters filled.");
            }
